...
export function buildCalendarioStudioPrompt(params: {
  ...
  return [
    ...
    "5) Usar investigacion web solo como insumo estrategico interno para aterrizar lenguaje, competencia, SEO, objeciones, escenas de uso y referencias culturales; no inventar precios, promociones, fechas ni claims duros.",
    ...
    "8) El copy final NO debe sonar a investigacion, benchmark, reporte, resumen de fuentes ni analisis de pagina web.",
    "9) No menciones 'web oficial', 'segun la web', 'fuentes', 'sitio oficial', nombres de articulos, proyectos, disenadores o referencias investigadas salvo que el usuario lo pida explicitamente.",
    "10) Convierte los datos investigados en beneficio, deseo, diferenciacion, autoridad y CTA. El lector debe recibir marketing final, no trazabilidad de fuentes.",
    "",
    ...premiumCreativeRules(),
    "",
    "CRITERIOS DE CALIDAD:",
    ...
    "1.2) caption debe leerse como pieza publicitaria terminada: narrativa persuasiva, ritmo comercial, beneficio claro y cierre con CTA; no como explicacion documental.",
    "1.3) Si usas atributos tecnicos o hallazgos web, traducelos a consecuencias deseables para el cliente; evita listar features como ficha tecnica.",
