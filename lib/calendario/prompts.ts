...
function userGenerationContextBlock(context?: {
  ...
  return [
    ...
    "Si hay extractos leidos de links, tratalos como fuente verificable prioritaria para oferta, lenguaje, beneficios, restricciones, pruebas y angulos.",
    "",
...
export function buildCalendarioStudioPrompt(params: {
  ...
  return [
    ...
    "",
    ...previousBundleBlock,
    "INVESTIGACION WEB — USAR PARA: lenguaje real del mercado, objeciones frecuentes, referencias culturales y angulos de diferenciacion.",
