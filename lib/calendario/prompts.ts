...
export function buildCalendarioDraftPrompt(params: {
  ...
  return [
    ...
    "",
    "OBJETIVO:",
    "Construir un calendario editorial que se sienta estrategico, creativo, diverso y comercialmente inteligente.",
    "Debe parecer trabajo de una agencia muy pro de marketing: fuerte en insight, criterio creativo, performance y claridad de ejecucion.",
    "",
    "CONTEXTO EMPRESA:",
    ...
    "10) Si hay multiples piezas del mismo canal o formato, diversifica angulo, CTA, pilar, buyer persona, tono y etapa del funnel.",
    "11) No llenes el calendario con ideas reformuladas. Cambia mecanismo narrativo, promesa y friccion.",
    ...
    "3) El conjunto debe verse como una mezcla balanceada de valor, diferenciacion, persuasion y conversion.",
