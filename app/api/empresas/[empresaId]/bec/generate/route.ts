...
export async function POST(request: Request, { params }: Params) {
  ...
  const systemPrompt = [
    ...
    'Para "Objetivo SMART 1" y "Objetivo SMART 2": redacta el objetivo estrategico aunque no haya porcentaje validado. No pongas porcentajes, umbrales ni metas numericas inventadas; formula el objetivo con accion, foco de negocio, resultado esperado y criterio de medicion ligado al KPI.',
    'Para "KPI Primario", "KPI Secundario" y "Métrica de Éxito / ROI Esperado": no inventes metas, porcentajes, umbrales, ROI ni KPIs. Si no hay evidencia suficiente, escribe exactamente: "Pendiente de validar con cliente segun metadata_json y contexto actual."',
